...
// y = A + xB
	...
	grafico->SetTitle("Raggio elettrone");
	grafico->GetXaxis()->SetTitle("#left(#frac{E'}{E}#right)^{2}#left(#frac{E}{E'}+#frac{E'}{E}-sin^{2}(#theta)#right)");
	grafico->GetXaxis()->CenterTitle();
	grafico->GetXaxis()->SetTitleOffset(1.2);
